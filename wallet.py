...
class Wallet:
    ...
    def sign_transaction(self, sender, recipient, amount, ehr):
        ...
        h = SHA256.new((str(sender) + str(recipient) + str(amount) + str(ehr)).encode('utf8'))
    ...
    def verify_transaction(transaction):
        ...
        h = SHA256.new((str(transaction.sender) + str(transaction.recipient) + str(transaction.amount) + str(transaction.ehr)).encode('utf8'))
